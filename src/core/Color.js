...
class Class {
  ...
  static fromRandom(options, result) {
    ...
    if (!defined(red)) {
      ...
      red = minimumRed + randomNum(1) * (maximumRed - minimumRed);
    }
    ...
    if (!defined(green)) {
      ...
      //>>includeEnd('debug');
      green = minimumGreen + randomNum(1) * (maximumGreen - minimumGreen);
    }
    ...
    if (!defined(blue)) {
      ...
      blue = minimumBlue + randomNum(1) * (maximumBlue - minimumBlue);
    }
    ...
    if (!defined(alpha)) {
      ...
      alpha = minimumAlpha + randomNum(1) * (maximumAlpha - minimumAlpha);
    }
